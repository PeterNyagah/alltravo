...
import cars.models.VanModel;
import e.wolfsoft1.liberty_ui_kit.R;
import utils.customfonts.MyTextView_Roboto_Regular;

public class VanAdapter extends RecyclerView.Adapter<VanAdapter.VanHolder> {
    ...
    public VanAdapter(Context context, ArrayList<CarModel> cars) {
    ...
    @NonNull
    @Override
    public VanAdapter.VanHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.car_list_recyclerview, parent, false);
        return new VanHolder(view);
    }


    @Override
    public void onBindViewHolder(@NonNull VanAdapter.VanHolder holder, int position) {
...
//
    ...
    class VanHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
